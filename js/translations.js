...
const translations = {
    ...
    ar: {
        ...
        hero_description: "تقديم البنية التحتية للبيانات الحيوية للشركات العالمية الكبرى. متخصص في الحوكمة والامتثال والحلول المدفوعة بعائد الاستثمار عبر البيئات السحابية المتعددة والهجينة. سجل حافل مُثبت في تقليل التكاليف التشغيلية مع ضمان الأمان والقابلية للتوسع على مستوى المؤسسات.",
        hero_cta: "← جدولة استشارة",
        ...
        metric_edf: "تقليل التكاليف 40% • تقليل وقت النشر بنسبة 70%",
    ...
    es: {
        ...
        result_scaling: "500% Capacidad de Escalamiento",
        ...
        result_uptime: "99.9% Tiempo de Actividad del Sistema",
        ...
        result_time_to_market: "60% Más Rápido Tiempo al Mercado",
        ...
        metric_edf: "40% Reducción de Costos • 70% de Reducción en Tiempo de Despliegue",
